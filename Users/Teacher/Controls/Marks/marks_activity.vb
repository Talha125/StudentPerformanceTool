...
Public Class marks_activity

    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Teacher.marks_activity_clicks(1)
    End Sub
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Teacher.marks_activity_clicks(0)
    End Sub

    Private Sub marks_activity_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cmd.CommandText = "select count(Total_Marks_Scored)as max from sem" & smstr & "_marks where Enrollment_No in(select enrollment_no from sem" & smstr & "_attend_sources where enrollment_no not like '" & enroll & "' and Activity_Attend>0);"
        rd = cmd.ExecuteReader
        rd.Read()
        ...
        cmd.CommandText = "select Total_Marks_Scored as others from sem" & smstr & "_marks where enrollment_no in(select enrollment_no from sem" & smstr & "_attend_sources where enrollment_no not like '" & enroll & "' and Activity_Attend>0);"
        rd = cmd.ExecuteReader
